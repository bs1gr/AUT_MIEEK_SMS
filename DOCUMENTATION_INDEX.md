...
**Last Updated:** December 19, 2025 (v1.12.1)  
**Version:** 1.12.1  
...
- **Release notes?** → `CHANGELOG.md` or `INSTALLER_RELEASE_NOTES_v1.12.1.md`
...
| `INSTALLER_RELEASE_NOTES_v1.12.1.md` | v1.12.1 release notes | End users |
...
└── INSTALLER_RELEASE_NOTES_v1.12.1.md (release notes)
```
...
```
archive/
├── pre-v1.12.1/                    (legacy content)
├── pre-v1.12.1-docker-scripts/     (old docker helpers)
...
4. **Release info?** → `INSTALLER_RELEASE_NOTES_v1.12.1.md`

---

## Documentation Updates

### December 5, 2025 (v1.12.1)
...
- See `archive/pre-v1.12.1/CHANGELOG_ARCHIVE.md` for legacy history
...
All documentation reflects the current state of the codebase and is verified accurate as of v1.12.1.
