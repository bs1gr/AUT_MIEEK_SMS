...
**Last Updated:** December 13, 2025 (v1.12.3)  
**Version:** 1.12.3  
...
- **Release notes?** → `CHANGELOG.md` or `docs/releases/RELEASE_NOTES_v1.12.3.md`
...
4. **Release info?** → `docs/releases/RELEASE_NOTES_v1.12.3.md`

---

## Documentation Updates

### December 13, 2025 (v1.12.3)
...
- See `archive/pre-v1.12.3/CHANGELOG_ARCHIVE.md` for legacy history
...
All documentation reflects the current state of the codebase and is verified accurate as of v1.12.3.
