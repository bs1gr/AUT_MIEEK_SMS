...
$backupPath = "d:\SMS\student-management-system\backups\pre_v1.15.1_$timestamp.db"
...
Test-Path docs/deployment/STAGING_DEPLOYMENT_PLAN_v1.15.1.md
# Expected: Both return True
```
...
- Deployment plan: `docs/deployment/STAGING_DEPLOYMENT_PLAN_v1.15.1.md`
