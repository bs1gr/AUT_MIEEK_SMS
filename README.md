...
1. **Download** `SMS_Distribution_1.8.7.zip` from [GitHub Releases](https://github.com/bs1gr/AUT_MIEEK_SMS/releases)
2. **Extract** to any location (Desktop, Downloads, etc.)
3. **Right-click** `SMS_Installer_1.8.7.exe` → **"Run as Administrator"**
