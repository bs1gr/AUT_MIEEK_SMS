# Release v1.3.6 (Draft)

Release date: 2025-11-02

## Overview

This release focuses on operational hardening (automated and safe database migrations), CI and developer ergonomics (type checking and dev dependency management), and small repo hygiene improvements. This draft increments the version to v1.3.6 to avoid conflicts with existing published releases.
...
1. Tag to create: `v1.3.6` (this draft replaces previous v1.3.5 notes to resolve naming conflicts).
...
1. Create and publish the release using tag `v1.3.6` and paste this release body.
