...
## 🔐 Security Checklist (REQUIRED for all RBAC PRs)
...
2. ✅ Tests added and passing (95%+ coverage)
3. ✅ Security review passed (2+ reviewers)
...
## 📝 Alternative: Feature Branch PR Template
...
| Test Coverage | ≥95% | Coverage reported in CI |
