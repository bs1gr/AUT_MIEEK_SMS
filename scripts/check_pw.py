...
if user:
    ...
    print('check YourSecurePassword123! ->', verify_password('YourSecurePassword123!', user.hashed_password))
    print('check settings.DEFAULT_ADMIN_PASSWORD ->', verify_password(settings.DEFAULT_ADMIN_PASSWORD or '', user.hashed_password))
else:
    print('No user')
s.close()
