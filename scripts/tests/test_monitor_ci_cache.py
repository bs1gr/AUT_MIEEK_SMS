...
class TestCacheMetricsCollector:
    ...
    def test_analyze_cache_performance_without_cache(self, sample_job_without_cache):
        ...
        assert metrics["npm_install_time"] == 60.0  # 60 seconds
        assert metrics["playwright_install_time"] == 30.0  # 30 seconds
        assert metrics["pip_install_time"] == 40.0  # 40 seconds
        assert metrics["total_setup_time"] == 130.0  # 60+30+40
