...
.EXAMPLE
    ...
    pwsh ./scripts/workflows/precommit_workflow.ps1

.EXAMPLE
    # Quick mode without cleanup or smoke
    pwsh ./scripts/workflows/precommit_workflow.ps1 -Mode quick -SkipCleanup -SkipSmoke
...
$cleanupScript   = Join-Path $workflowsDir "cleanup_pre_release.ps1"
$smokeScript     = Join-Path $scriptsDir "SMOKE_TEST.ps1"
...
(Template auto-generated by scripts/workflows/precommit_workflow.ps1)
"@
