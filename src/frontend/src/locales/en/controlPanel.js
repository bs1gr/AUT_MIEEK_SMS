export default {
  ...
  updateNow: 'Update',
  updateManualAction: 'View Update Steps',
  updateNowHint: 'Downloads the installer and starts in-place update for the available version.',
  updateDockerHint: 'Docker mode: tries host updater bridge first; if unavailable, run .\\DOCKER.ps1 -UpdateClean on the host machine.',
  updateDockerManualCta: 'Docker host bridge unavailable. Opened release details. Run .\\DOCKER.ps1 -UpdateClean on the host machine to apply this update.',
  updateInstallerMissing: 'Installer asset is not available for this release yet. Please open the release page and retry shortly.',
  downloadAndInstallNow: 'Download & Install Now',
  downloadAndInstallHint: 'Downloads the selected release installer, verifies SHA256 when available, and starts in-place update.',
  updateInstallingNow: 'Preparing installer...',
  updateInstallStarted: 'Installer launched. Follow installer prompts to complete the update.',
  updateInstallFailed: 'Automatic update failed. Please run the installer manually.',
  updaterTimelineTitle: 'Smart Updater Timeline',
  updaterPhase: 'Phase',
  updaterProgress: 'Progress',
  updaterInstallerState: 'Installer',
  updaterInstallerLaunched: 'Launched',
  updaterInstallerPending: 'Pending',
  updaterDownloadBytes: 'Downloaded',
  updaterProcessId: 'Process ID',
  updaterAuditTrail: 'Audit trail',
  updaterOccurrences: '{{count}}x',
  updaterModeGrouped: 'Grouped',
  updaterModeRaw: 'Raw',
  // Rate Limiting Panel
  ...
  rateLimits: {
    ...
    adjustInfo: 'Adjust these limits if users experience 429 (Too Many Requests) errors.',
    requestsPerMin: 'requests per minute',
    default: 'Default',
    descRead: 'GET requests',
    descWrite: 'POST/PUT requests',
    descHeavy: 'Heavy operations',
    descAuth: 'Login attempts',
    descImport: 'Bulk imports',
    loading: 'Loading...',
    loadError: 'Failed to load rate limit settings',
    modified: 'Modified',
    saving: 'Saving...',
    saveChanges: 'Save Changes',
    saveError: 'Failed to save changes',
    updateSuccess: 'Rate limits updated successfully',
    resetButton: 'Reset Defaults',
    confirmReset: 'Reset all rate limits to defaults?',
    resetSuccess: 'Rate limits reset to defaults',
    resetError: 'Failed to reset limits',
  },
  // Database Management Panel
  db: {
    label: 'Database',
    title: 'Database Management',
    subtitle: 'Monitor PostgreSQL instances, create backups, and restore data.',
    credentialsTitle: 'Remote Database Credentials',
    credentialsSubtitle: 'Upload a .json or .env credentials file to validate and optionally connect to a remote PostgreSQL instance.',
    credentialsSelectFile: 'Credentials file',
    credentialsSelected: 'Selected',
    credentialsAutoConnect: 'Automatically apply credentials after successful validation',
    credentialsValidateAndConnect: 'Validate & Connect',
    credentialsValidateOnly: 'Validate File',
    credentialsTestOnly: 'Test Only',
    credentialsFileRequired: 'Please select a credentials file first.',
    credentialsImportSuccess: 'Credentials validated successfully.',
    credentialsImportFailed: 'Credentials validation failed.',
    loading: 'Loading database instances…',
    instances: 'Database Instances',
    refresh: 'Refresh',
    noInstances: 'No database instances configured.',
    primary: 'Primary',
    healthy: 'Healthy',
