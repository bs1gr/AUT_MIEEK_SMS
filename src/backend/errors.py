...
class ErrorCode(str, Enum):
    ...
    COURSE_NO_ENROLLMENTS = "CRS_NO_ENROLLMENTS"
    ...
    SEMESTER_ARCHIVE_NOT_FOUND = "SEMARC_NOT_FOUND"
    SEMESTER_ARCHIVE_EXPORT_FAILED = "SEMARC_EXPORT_FAILED"
    SEMESTER_ARCHIVE_CONFIRMATION_MISMATCH = "SEMARC_CONFIRM_MISMATCH"
    SEMESTER_ARCHIVE_EXECUTION_FAILED = "SEMARC_EXEC_FAILED"
