...
def register_routers(app: FastAPI) -> None:
    ...
    _try_add("backend.routers.routers_custom_reports", "Custom Reports")
    ...
    _try_add("backend.routers.routers_permissions", "Permissions Management")
    ...
    _try_add("backend.routers.routers_semester_archive", "Semester Archive")
