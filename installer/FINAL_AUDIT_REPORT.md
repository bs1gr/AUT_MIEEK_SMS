...
| `SMS_Installer_1.9.4.exe` | 15:51:22 | ✅ Built AFTER source (11 min later) |
...
& signtool.exe sign /f "installer\AUT_MIEEK_CodeSign.pfx" /p "SMSCodeSign2025!" /t http://timestamp.digicert.com /fd SHA256 /v "dist\SMS_Installer_1.9.4.exe"
