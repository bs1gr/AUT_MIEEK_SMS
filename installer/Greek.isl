...
DbConfigPageSubtitle=Επιλέξτε τοπική SQLite ή σύνδεση με τη βάση QNAP PostgreSQL.
DbConfigIntro=Επιλέξτε τον τρόπο βάσης δεδομένων για αυτή την εγκατάσταση.
DbLocalOption=Τοπική SQLite (ένας υπολογιστής, η πιο εύκολη επιλογή)
DbLocalHint=Προτείνεται για τους περισσότερους χρήστες. Δεν χρειάζονται επιπλέον ρυθμίσεις.
DbRemoteOption=QNAP PostgreSQL (κοινόχρηστη βάση στο NAS)
DbRemoteHint=Χρησιμοποιήστε το μόνο αν ο PostgreSQL server στο NAS είναι ήδη ρυθμισμένος και προσβάσιμος από αυτόν τον υπολογιστή.
