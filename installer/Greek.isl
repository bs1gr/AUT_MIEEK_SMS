...
NativeProdPrereqsTitle=Απαιτήσεις Native Production
NativeProdPrereqsSubtitle=Έλεγχος απαιτούμενου Python και Node.js
NativeLitePrereqsTitle=Απαιτήσεις Native Lite
NativeLitePrereqsSubtitle=Επαλήθευση συμβατότητας συστήματος
PythonCheck=Python 3.10+
NodeJsCheck=Node.js 18+
PostgreSqlCheck=PostgreSQL (Προαιρετικό)
