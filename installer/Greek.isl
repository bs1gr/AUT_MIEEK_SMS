...
OpenDockerPage=’νοιγμα σελίδας λήψης Docker Desktop
...
UpgradeOption=Αναβάθμιση (διατήρηση δεδομένων)
CleanInstallOption=Καθαρή εγκατάσταση (διαγραφή όλων)
CancelOption=Ακύρωση
KeepUserData=Διατήρηση δεδομένων χρήστη
RemoveOldVersion=Αφαίρεση προηγούμενης έκδοσης
UpgradePrompt=Πατήστε ΝΑΙ για αναβάθμιση, ΟΧΙ για καθαρή εγκατάσταση, ή ΑΚΥΡΟ.
