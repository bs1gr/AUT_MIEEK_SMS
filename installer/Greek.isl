...
DbCredentialsFile=Αρχείο διαπιστευτηρίων (.json ή .env)
DbBrowse=Αναζήτηση...
...
DbFileRequired=Παρακαλώ επιλέξτε αρχείο διαπιστευτηρίων βάσης (.json ή .env).
DbFileMissing=Το επιλεγμένο αρχείο διαπιστευτηρίων δεν βρέθηκε.
DbFileUnsupported=Μη υποστηριζόμενη μορφή αρχείου. Χρησιμοποιήστε αρχείο .json ή .env.
DbFileLoadFailed=Αποτυχία ανάγνωσης του αρχείου διαπιστευτηρίων.
DbMissingRequired=Λείπουν υποχρεωτικά διαπιστευτήρια (host και password).
