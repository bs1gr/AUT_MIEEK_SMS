...
import { User, Mail, Calendar, Award, TrendingUp, BookOpen, CheckCircle, XCircle, Star, ArrowLeft } from 'lucide-react';
import { studentsAPI, gradesAPI, attendanceAPI, highlightsAPI } from '../../api/api';
                ...
                return (
                  <div key={grade}>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-gray-600">{count} assignments ({percentage.toFixed(0)}%)</span>
                    </div>
