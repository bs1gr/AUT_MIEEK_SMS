...
// Note: studentsAPI.getAll returns paginated in api.ts, but useStudents casts to Student[] and expects an array.
// Therefore in tests, we mock getAll to return an array of students.
