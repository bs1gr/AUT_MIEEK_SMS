...
export default {
  ...
  field_note: 'Σημείωση',
  field_study_year: 'Τάξη',
  field_academic_year: 'Τάξη',
  ...
  field_hours_per_week: 'Ώρες Επαφής ανά Εβδομάδα',
  field_periods_per_week: 'Περίοδοι ανά Εβδομάδα',
  ...
  field_attendance_rate: 'Ποσοστό Παρουσιών',
  ...
  template_students_by_year: 'Μαθητές ανά Τάξη',
  template_students_by_year_desc: 'Κατανομή μαθητών ανά τάξη με στατιστικά εγγραφών.',
  ...
  template_performance_by_year: 'Ανάλυση Απόδοσης - Κατά Τάξη',
  template_performance_by_year_desc: 'Απόδοση μαθητών χωρισμένη κατά τάξη με μετρήσεις GPA και παρουσιών',
