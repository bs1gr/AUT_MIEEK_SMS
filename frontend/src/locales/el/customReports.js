...
export default {
  ...
  analyticsTemplatesDescription: 'Προεπιλεγμένες αναφορές ανάλυσης και απόδοσης',
  csvTemplatesDescription: 'Εξαγωγή δεδομένων σε μορφή CSV για υπολογιστικά φύλλα',
