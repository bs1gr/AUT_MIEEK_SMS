export default {
  ...
  monitoring: {
    ...
    grafanaDesc: 'Visual dashboards with charts, graphs, and real-time metrics. View request rates, response times, error rates, and business metrics.',
    prometheusDesc: 'Query and explore metrics using PromQL. View targets, alerts, and create custom queries.',
    metricsDesc: 'Raw Prometheus-format metrics exported by the application. Includes HTTP metrics, business metrics, database performance, and more.',
    openGrafana: 'Open Grafana',
    openPrometheus: 'Open Prometheus',
    viewMetrics: 'View Raw Metrics',
    credentials: 'Default Credentials',
    selectLabel: 'Dashboard',
    selectPlaceholder: 'Choose a dashboard',
    descriptionDashboards: 'Switch between prebuilt SMS analytics dashboards.',
    openCurrent: 'Open in new tab',
    quickLinks: 'Quick links',
    dashboards: {
      business: 'SMS Business Analytics',
