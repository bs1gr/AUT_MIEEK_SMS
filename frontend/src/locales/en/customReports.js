...
export default {
  ...
  field_letter_grade: 'Letter Grade',
  field_notes: 'Notes',
  field_date: 'Date',
  field_status: 'Status',
  field_period_number: 'Period',
  field_study_year: 'Study Year',
  field_year_of_study: 'Study Year',
  field_academic_year: 'Academic Year',
  field_class_division: 'Class Division',
  field_health_issue: 'Health Issue',
  field_note: 'Note',
  field_gpa: 'GPA',
  field_average_grade: 'Average Grade',
  field_attendance_rate: 'Attendance Rate',
  field_total_classes: 'Total Classes',
  field_attended: 'Classes Attended',
  field_total_assignments: 'Total Assignments',
  field_total_courses: 'Total Courses',
  field_passed_courses: 'Passed Courses',
  field_failed_courses: 'Failed Courses',
  field_total_credits: 'Total Credits',
  field_enrollment_status: 'Enrollment Status',
  field_trend: 'Performance Trend',
  field_hours_per_week: 'Hours per Week',
  field_absence_penalty: 'Absence Penalty',
  field_enrollment_count: 'Enrollment Count',
  field_total_students: 'Total Students',
  ...
  template_student_performance_detailed: 'Student Performance - Detailed Analytics',
  template_student_performance_detailed_desc: 'Detailed student performance metrics with GPA, attendance, credits, and pass/fail summary',
  ...
  template_grade_analytics_weighted: 'Grade Analytics - Weighted Overview',
  template_grade_analytics_weighted_desc: 'Assignment-level grade analytics with weights, percentages, and letter grades',
  template_student_engagement: 'Student Engagement - Attendance & Grades',
  template_student_engagement_desc: 'Engagement snapshot combining attendance, grade averages, and workload metrics',
