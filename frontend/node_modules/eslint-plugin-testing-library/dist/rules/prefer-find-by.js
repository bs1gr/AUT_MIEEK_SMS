    ...
    create(context, _, helpers) {
        ...
        return {
            'AwaitExpression > CallExpression'(node) {
                ...
                if (!(0, node_utils_1.isCallExpression)(argumentBody)) {
                    return;
                }
                if (isScreenSyncQuery(argument)) {
                    ...
                    reportInvalidUsage(node, {
                        ...
                        fix(fixer) {
                            ...
                            if (!(0, node_utils_1.isMemberExpression)(argumentBody.callee))
                                return null;
                            const { property, object } = argumentBody.callee;
                            if (utils_1.ASTUtils.isVariableDeclarator(node.parent.parent)) {
                                if ((0, ast_utils_1.isIdentifier)(property) && helpers.isCustomQuery(property)) {
                                    return null;
                                }
                                return fixer.replaceText(node, findByCallText);
                            }
                            if (!(0, node_utils_1.isCallExpression)(object))
                                return null;
                ...
                reportInvalidUsage(node, {
                    ...
                    prevQuery: fullQueryMethod,
                    fix(fixer) {
                        if (helpers.isCustomQuery(argumentBody.callee)) {
                            return null;
                        }
