...
def test_filter_attendance_by_student(client):
    ...
    # Create two students
    student1_resp = client.post("/api/v1/students/", json={
        "student_id": "ATT005",
    ...
    student2_resp = client.post("/api/v1/students/", json={
        "student_id": "ATT006",
...
def test_update_attendance(client):
    ...
    # Create attendance
    create_resp = client.post("/api/v1/attendance/", json={
        "student_id": student_id,
        "course_id": course_id,
        "date": str(date.today()),
        "status": "Absent"
    ...
    # Update to Present
    response = client.put(f"/api/v1/attendance/{attendance_id}", json={
        "status": "Present"
    })
