...
def test_public_registration_cannot_set_admin(client):
    payload = {
        "email": "public_admin@example.com",  # pragma: allowlist secret
...
def test_admin_token_allows_setting_role(client):
    ...
    creator = {
        ...
        "password": "CreatorPass1!",  # pragma: allowlist secret
    ...
    new_user = {
        "email": "elevated@example.com",  # pragma: allowlist secret
        "password": "UserPass1!",  # pragma: allowlist secret
        "role": "admin",
    }
    r3 = client.post(
...
def test_invalid_or_expired_admin_token_is_ignored(client):
    ...
    r2 = client.post(
        ...
        json={
            ...
            "password": "UserPass2!",  # pragma: allowlist secret
            "role": "admin",
        },  # pragma: allowlist secret
