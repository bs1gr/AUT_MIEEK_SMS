...
ERROR_MESSAGES_EL: Dict[str, str] = {
    ...
    ErrorCode.ATTENDANCE_NOT_FOUND: "Η παρουσία δεν βρέθηκε. Παρακαλώ επαληθεύστε την ημερομηνία και τον αριθμό μητρώου.",
    ...
    ErrorCode.INVALID_DATE_RANGE: "Μη έγκυρο εύρος ημερομηνιών. Η ημερομηνία έναρξης πρέπει να είναι πριν την ημερομηνία λήξης.",
    ...
    ErrorCode.EMPTY_STUDENT_LIST: "Πρέπει να παρέχεται τουλάχιστον ένας φοιτητής. Παρακαλώ επιλέξτε έναν ή περισσότερους φοιτητές.",
    ErrorCode.INVALID_PERIOD: "Μη έγκυρη περίοδος. Για προσαρμοσμένη περίοδο, απαιτούνται και οι δύο ημερομηνίες έναρξης και λήξης.",
    # Authorization errors
    ...
    ErrorCode.JOB_ACCESS_DENIED: "Δεν επιτρέπεται η πρόσβαση. Μπορείτε να δείτε μόνο τις δικές σας εργασίες παρασκηνίου.",
    # Business logic errors
    ...
    ErrorCode.DATABASE_ERROR: "Προέκυψε σφάλμα βάσης δεδομένων. Παρακαλώ δοκιμάστε ξανά ή επικοινωνήστε με την υποστήριξη.",
    ErrorCode.INTERNAL_ERROR: "Προέκυψε ένα απροσδόκητο σφάλμα. Η ομάδα μας έχει ενημερωθεί. Παρακαλώ δοκιμάστε ξανά αργότερα.",
}
