...
class ReportTemplateBase(BaseModel):
    ...
    fields: Dict[str, Any] = Field(..., description="Fields to include in report")
    filters: Optional[Dict[str, Any]] = Field(None, description="Default filter criteria")
    aggregations: Optional[Dict[str, Any]] = Field(None, description="Aggregation configuration")
