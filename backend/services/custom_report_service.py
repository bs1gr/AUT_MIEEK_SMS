    ...
    def import_default_templates(self) -> int:
        ...
        default_templates = [
            ...
            ReportTemplate(
                ...
                report_type="grade",
                is_system=True,
                fields=["student_id", "student_name", "course_id", "course_name", "grade_value", "exam_date"],
                filters=[],
                aggregations=None,
            ),
            ReportTemplate(
                ...
                report_type="student",
                is_system=True,
                fields=["id", "first_name", "last_name", "attendance_rate", "total_classes", "attended"],
                filters=[],
                aggregations=None,
            ),
            ReportTemplate(
            ...
            ReportTemplate(
                ...
                report_type="student",
                is_system=True,
                fields=["id", "first_name", "last_name", "gpa", "attendance_rate", "enrollment_status"],
                filters=[],
            ...
            ReportTemplate(
                ...
                report_type="student",
                is_system=True,
                fields=["id", "first_name", "last_name", "gpa", "attendance_rate", "passed_courses"],
                filters=[{"field": "gpa", "operator": "gte", "value": 3.5}],
                aggregations=None,
            ),
            ReportTemplate(
            ...
            ReportTemplate(
                ...
                report_type="grade",
                is_system=True,
                fields=["course_id", "course_name", "grade_value", "student_id"],
                filters=[],
                aggregations={"group_by": "course_id"},
            ),
        ]
