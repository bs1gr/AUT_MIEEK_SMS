...
class ErrorCode(str, Enum):
    ...
    CONTROL_PACKAGE_JSON_MISSING = "CTL_PACKAGE_MISSING"
    CONTROL_NPM_NOT_FOUND = "CTL_NPM_NOT_FOUND"
    CONTROL_INSTALL_ERROR = "CTL_INSTALL_ERROR"
    CONTROL_REQUIREMENTS_MISSING = "CTL_REQUIREMENTS_MISSING"
    CONTROL_DOCKER_NOT_RUNNING = "CTL_DOCKER_NOT_RUNNING"
    CONTROL_DOCKERFILE_MISSING = "CTL_DOCKERFILE_MISSING"
    CONTROL_BUILD_FAILED = "CTL_BUILD_FAILED"
    CONTROL_LOGS_ERROR = "CTL_LOGS_ERROR"
    CONTROL_CLEANUP_FAILED = "CTL_CLEANUP_FAILED"
    CONTROL_VOLUME_UPDATE_FAILED = "CTL_VOLUME_UPDATE_FAILED"
