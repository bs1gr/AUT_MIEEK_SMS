...
from fastapi import status, HTTPException, Body, Depends, Request, Response, APIRouter
from datetime import datetime, timedelta, timezone


# get_current_user dependency is defined locally below to avoid circular imports
...
# Import get_current_user from new location to break circular import
...
# Import password hash helpers from new module
...
# Reuse canonical auth helpers from centralized module to avoid duplication/circular imports
