...
def upgrade() -> None:
    ...
    op.alter_column('export_jobs', 'total_records',
               existing_type=sa.INTEGER(),
               nullable=True,
               existing_server_default=sa.text("'0'"))
    op.alter_column('export_jobs', 'scheduled',
    ...
    op.alter_column('import_export_history', 'timestamp',
               existing_type=sa.DATETIME(),
               nullable=True,
               existing_server_default=sa.text('(CURRENT_TIMESTAMP)'))
    op.create_index(op.f('ix_import_export_history_operation_type'), 'import_export_history', ['operation_type'], unique=False)
    op.create_index(op.f('ix_import_export_history_resource_type'), 'import_export_history', ['resource_type'], unique=False)
    op.alter_column('import_jobs', 'successful_rows',
               existing_type=sa.INTEGER(),
               nullable=True,
               existing_server_default=sa.text("'0'"))
    op.alter_column('import_jobs', 'failed_rows',
               existing_type=sa.INTEGER(),
               nullable=True,
               existing_server_default=sa.text("'0'"))
    ...
    op.alter_column('import_rows', 'created_at',
               existing_type=sa.DATETIME(),
               nullable=True,
               existing_server_default=sa.text('(CURRENT_TIMESTAMP)'))
