...
def upgrade() -> None:
    ...
    if not _index_exists("notifications", "idx_user_notifications"):
        op.create_index("idx_user_notifications", "notifications", ["user_id", "created_at"], unique=False)
    if not _index_exists("notifications", "idx_unread_notifications"):
        op.create_index("idx_unread_notifications", "notifications", ["user_id", "is_read"], unique=False)
    if not _index_exists("notifications", op.f("ix_notifications_is_read")):
        op.create_index(op.f("ix_notifications_is_read"), "notifications", ["is_read"], unique=False)
    if not _index_exists("notifications", op.f("ix_notifications_created_at")):
        op.create_index(op.f("ix_notifications_created_at"), "notifications", ["created_at"], unique=False)
    if not _index_exists("notifications", op.f("ix_notifications_user_id")):
    ...
    if not _index_exists("notification_preferences", op.f("ix_notification_preferences_user_id")):
        op.create_index(
...
def downgrade() -> None:
    if _table_exists("notification_preferences"):
        if _index_exists("notification_preferences", op.f("ix_notification_preferences_user_id")):
            op.drop_index(op.f("ix_notification_preferences_user_id"), table_name="notification_preferences")
        op.drop_table("notification_preferences")
    if _table_exists("notifications"):
        if _index_exists("notifications", op.f("ix_notifications_user_id")):
            op.drop_index(op.f("ix_notifications_user_id"), table_name="notifications")
        if _index_exists("notifications", op.f("ix_notifications_created_at")):
            op.drop_index(op.f("ix_notifications_created_at"), table_name="notifications")
        if _index_exists("notifications", op.f("ix_notifications_is_read")):
            op.drop_index(op.f("ix_notifications_is_read"), table_name="notifications")
        if _index_exists("notifications", "idx_unread_notifications"):
            op.drop_index("idx_unread_notifications", table_name="notifications")
        if _index_exists("notifications", "idx_user_notifications"):
