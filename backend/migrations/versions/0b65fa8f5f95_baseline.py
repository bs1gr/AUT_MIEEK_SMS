...
def upgrade() -> None:
    ...
    op.create_index('idx_enrollment_student_course', 'course_enrollments', ['student_id', 'course_id'], unique=True)
    ...
    op.create_index('idx_performance_student_course', 'daily_performances', ['student_id', 'course_id'])
