...
revision: str = "8e1a2c3b4d5e"  # pragma: allowlist secret
down_revision: Union[str, None] = "00c146dcf611"  # pragma: allowlist secret
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_user_role_unique", "user_roles", ["user_id", "role_id"], unique=True
    )
