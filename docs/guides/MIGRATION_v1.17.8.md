...
Version $11.18.3 moves the legacy Power and RBAC pages into the feature module architecture and standardizes i18n usage. This is a **breaking change only for developers who import these pages directly**. End users and standard deployments are unaffected.
