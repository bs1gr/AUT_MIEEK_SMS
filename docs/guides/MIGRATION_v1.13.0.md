# Migration Guide: v1.12.9 → v1.13.0
...
Version 1.13.0 removes all deprecated backend modules that were marked for deprecation in v1.11.0-v1.12.9. This is a **breaking change** requiring import path updates if you use any of the removed modules.

**Good News:**
- ✅ All removed modules have functional replacements already in place
- ✅ Modern replacements have been available since v1.11.0
...
- ✅ You already updated to new import paths in v1.11.0+
...
#!/usr/bin/env python3
"""
Automated import migration script for v1.13.0
...
def main(directory: str = "."):
    ...
    if total_files == 0:
        print("No deprecated imports found - you're already using v1.13.0 paths!")
...
If you encounter issues and need to rollback to v1.12.9:
...
### Q: Can I still use v1.12.9?
**A:** Yes, v1.12.9 remains fully functional with deprecated modules. However, we recommend migrating to v1.13.0 for ongoing support.

### Q: Will there be more breaking changes?
**A:** No deprecated code remains after v1.13.0. Future releases will maintain backward compatibility unless major architectural changes are needed.
...
- [Cleanup Report](../releases/reports/CLEANUP_EXECUTION_REPORT_v1.13.0.md) - Technical details
