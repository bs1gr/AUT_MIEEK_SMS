...
- `docs/releases/v1.9.3.md` - Historical release notes (DO NOT change)
- `RELEASE_SUMMARY_v1.9.6.md` - Previous release summary (archived reference)
- `archive/` directory - Historical documents (preserve as-is)
- `installer/` docs - Related to v1.9.4 installer build (will update on next installer build)
