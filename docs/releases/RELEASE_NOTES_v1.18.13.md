...
**Scope Baseline**: `vvv1.18.22..HEAD`
...
- [x] Release scope reviewed against `vvv1.18.22..HEAD`
- [x] Version metadata aligned to `vvv1.18.22` (`VERSION`, `frontend/package.json`, doc indexes, key script headers)
- [x] Release-note artifacts generated for vvv1.18.22
