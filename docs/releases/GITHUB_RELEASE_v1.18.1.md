# $11.18.3 - Test Fixes & Documentation Updates

## 🐛 Bug Fixes

This patch release addresses test failures and documentation gaps from the $11.18.3 auto-activation enhancement:
...
- **Documentation updates**: $11.18.3 release notes enhanced with auto-activation details

## 🔧 What Was Fixed

### Course Modal Test Failures
The $11.18.3 auto-activation enhancement changed the UI structure for semester year inputs, causing test selector mismatches:
...
No changes to deployment or installation procedures. This is a drop-in replacement for $11.18.3.
...
### From $11.18.3
No special steps required - $11.18.3 is fully compatible:
...
- **Parent release**: [$11.18.3](https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/$11.18.3)
- **Auto-activation feature**: Implemented in $11.18.3 with 4 commits
