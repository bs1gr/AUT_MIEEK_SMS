...
- [ ] `COMMIT_READY.ps1` version reference is `v1.18.25`
...
### 2.1 Create Tag
```powershell
git tag -a v1.18.25 -m "v1.18.25: Control Panel Auto-Updater, Offline Sync, Health Diagnostics"
...
- [ ] Work plan updated with v1.18.25 release status
...
# Installer rollback
# Use v1.18.25 installer from previous release
```
