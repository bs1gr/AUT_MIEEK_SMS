...
| Hash | Description |
|---|---|
| `336551437` | chore(release): record v1.18.25 publication evidence -- GitHub digest, state snapshot |
...
| `fcb2570f6` | chore(release): prepare v1.18.25 |
...
- ✅ Commit `fcb2570f6` (`chore(release): prepare v1.18.25`) pushed to `main`
- ✅ Tag `v1.18.25` created and pushed (`2026-03-31`)
