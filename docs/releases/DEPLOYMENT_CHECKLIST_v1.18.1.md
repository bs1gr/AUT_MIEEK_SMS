...
- [ ] Release notes: `docs/releases/RELEASE_NOTES_$11.18.3.md` exists
...
- [ ] GitHub release body: `docs/releases/GITHUB_RELEASE_$11.18.3.md`
- [ ] Release manifest: `docs/releases/RELEASE_MANIFEST_$11.18.3.md`
...
git tag -a $11.18.3 -m "Release $11.18.3 - Test fixes and documentation updates"
...
git log --oneline -1
git ls-remote --tags origin | Select-String "$11.18.3"
```

**Expected Output:**
- Commits pushed successfully
- Tag $11.18.3 visible on remote
...
2. Select tag: `$11.18.3`
3. Release title: `$11.18.3 - Test Fixes & Documentation Updates`
4. Copy body from: `docs/releases/GITHUB_RELEASE_$11.18.3.md`
5. Set as latest release: ✅ Yes
6. Set as pre-release: ❌ No
7. Click "Publish release"

**Verification:**
- [ ] Release visible at: https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/$11.18.3
...
git push origin :refs/tags/$11.18.3
...
# Create $11.18.3 with fixes
```

**Scenario 3: Critical bug found after release**
```powershell
# Create hotfix branch
git checkout -b hotfix/$11.18.3
...
# Create $11.18.3 release
.\GENERATE_RELEASE_DOCS.ps1 -Version "1.18.2"
# ... follow this checklist for $11.18.3 ...
```
...
- [ ] Update `docs/plans/UNIFIED_WORK_PLAN.md`: Mark $11.18.3 as released
- [ ] Update `docs/DOCUMENTATION_INDEX.md`: Add $11.18.3 release entry (if needed)
...
- [ ] Ready for next release planning ($11.18.3)
