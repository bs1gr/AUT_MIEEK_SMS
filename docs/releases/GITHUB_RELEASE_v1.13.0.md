...
Windows Installer: Download StudentManagementSystem_1.13.0_Setup.exe from the assets below.
...
- docs/development/release-workflow/WORKFLOW_FIXES/fix-1-commit-ready-smoke.yml
- docs/development/release-workflow/WORKFLOW_FIXES/fix-2-e2e-tests.yml
...
- docs/reports/2025-12/FINAL_SUMMARY.txt
- docs/reports/2025-12/REMAINING_ISSUES_FINAL_SUMMARY.md
- docs/reports/2025-12/SESSION_2025_12_28_FINAL.txt
...
- test-results/e2e/e2e-error-attendance/error-context.md
