# v1.18.3 Release Fix - Immediate Action Plan

**Status**: READY FOR EXECUTION
**Date**: February 3, 2026
**Objective**: Complete v1.18.3 GitHub release with proper assets and documentation

---

## Critical Issue Summary

GitHub release v1.18.3 was created manually via `gh CLI` which bypassed all CI/CD automation:

| Component | Status | Issue |
|-----------|--------|-------|
| Release body | ❌ Broken | Shows "Release v1.18.3" instead of 276+ line notes |
| Installer asset | ❌ Missing | No SMS_Setup_v1.18.3.exe attached |
...
**Why**: `.github/workflows/release-on-tag.yml` looks for release notes at `.github/RELEASE_NOTES_v1.18.3.md`
...
Test-Path ".github/RELEASE_NOTES_v1.18.3.md"  # Should output: True
Get-Item ".github/RELEASE_NOTES_v1.18.3.md" | Select-Object Length  # Should show ~12-15KB
```

**Verification**:
- File exists at `.github/RELEASE_NOTES_v1.18.3.md` ✅
...
git commit -m "docs(release): add v1.18.3 release notes to .github/ for CI/CD automation"

# Verify commit
git log --oneline -1  # Should show: docs(release): add v1.18.3 release notes...
...
**Expected Output**:
```
[main 9a1b2c3d4] docs(release): add v1.18.3 release notes to .github/ for CI/CD automation
 1 file changed, 276 insertions(+)
 create mode 100644 .github/RELEASE_NOTES_v1.18.3.md
```

**Verification**:
- Commit created and pushed ✅
- Visible on origin/main ✅
- File accessible at `.github/RELEASE_NOTES_v1.18.3.md` ✅

---

### Step 3: Delete Incomplete Manual Release ❌

**Why**: Current release v1.18.3 is incomplete (no assets, minimal body)
...
gh release view v1.18.3 --json assets,body,isDraft

# Expected (before fix):
# assets: [] (empty)
# body: "Release v1.18.3" (minimal)
# isDraft: false
...
# Verify deletion
gh release view v1.18.3 2>&1  # Should show: "release not found" error
```

**What Gets Deleted**:
- GitHub release page for v1.18.3
...
**Verification**:
- Release v1.18.3 no longer visible on GitHub ✅
- `gh release view v1.18.3` returns error ✅
...
git tag -a v1.18.3 -m "Release v1.18.3 - Internationalization improvements, deployment reliability, and historical data editing"

# Verify tag created locally
git tag -l -n1 v1.18.3  # Should show: v1.18.3 Release v1.18.3 - ...

# PUSH TAG TO ORIGIN (THIS TRIGGERS CI/CD AUTOMATION)
git push origin v1.18.3

# Verify tag pushed
git ls-remote --tags origin v1.18.3  # Should show remote tag
```
...
4. ✅ Release notes loaded from `.github/RELEASE_NOTES_v1.18.3.md`
...
# Common issues:
# 1. Path error in release notes - Check .github/RELEASE_NOTES_v1.18.3.md exists
...
gh release view v1.18.3 --json body -q .body | Measure-Object -Line
# Expected: 276 lines

# Show all assets
gh release view v1.18.3 --json assets -q '.assets[] | "\(.name) - \(.size) bytes"'
# Expected: SMS_Setup_v1.18.3.exe - [file size] bytes

# Check release timestamps
gh release view v1.18.3 --json createdAt,publishedAt
...
- ✅ Assets array contains SMS_Setup_v1.18.3.exe
...
- [ ] Release notes exist at `docs/releases/RELEASE_NOTES_v1.18.3.md`
...
|------|--------|---------|--------|
| 1 | Copy release notes to .github/ | `Copy-Item "docs/releases/RELEASE_NOTES_v1.18.3.md" ".github/RELEASE_NOTES_v1.18.3.md"` | ⬜ |
| 2 | Commit to git | `git add & commit` | ⬜ |
| 3 | Push to origin/main | `git push origin main` | ⬜ |
| 4 | Delete incomplete release | `gh release delete v1.18.3 --yes` | ⬜ |
| 5 | Create git tag | `git tag -a v1.18.3 -m "..."` | ⬜ |
| 6 | Push git tag | `git push origin v1.18.3` | ⬜ |
| 7 | Monitor CI/CD | Check GitHub Actions (10-15 min) | ⬜ |
| 8 | Verify completion | Run `gh release view v1.18.3` | ⬜ |
...
# (Edit .github/RELEASE_NOTES_v1.18.3.md)

# Commit fix
git add ".github/RELEASE_NOTES_v1.18.3.md"
git commit -m "docs(release): fix v1.18.3 release notes"
git push origin main
...
$ git ls-remote --tags origin v1.18.3
[commit-hash] refs/tags/v1.18.3

$ git log origin/main --oneline -1
[new commit]: docs(release): add v1.18.3 release notes to .github/ for CI/CD automation
```
...
1. **Update `.github/workflows/release-on-tag.yml`** (for v1.18.3+):
...
4. **Update UNIFIED_WORK_PLAN.md**:
   - Document v1.18.3 completion
   - Lessons learned section
   - Recommended process for v1.18.3+
...
✅ GitHub release v1.18.3 shows 276+ line release notes
...
**Questions?** Check CI_CD_RELEASE_WORKFLOW_AUDIT_v1.18.3.md for detailed background.
