...
|-----------|--------|-------|
| Release body | ❌ Broken | Shows "Release v1.17.7" instead of 276+ line notes |
| Installer asset | ❌ Missing | No SMS_Setup_v1.17.7.exe attached |
...
**Verification**:
- File exists at `.github/RELEASE_NOTES_v1.17.7.md` ✅
...
- File accessible at `.github/RELEASE_NOTES_v1.17.7.md` ✅
...
**Verification**:
- Release v1.17.7 no longer visible on GitHub ✅
- `gh release view v1.17.7` returns error ✅
...
4. ✅ Release notes loaded from `.github/RELEASE_NOTES_v1.17.7.md`
...
- ✅ Assets array contains SMS_Setup_v1.17.7.exe
...
|------|--------|---------|--------|
| 1 | Copy release notes to .github/ | `Copy-Item "docs/releases/RELEASE_NOTES_v1.17.7.md" ".github/RELEASE_NOTES_v1.17.7.md"` | ⬜ |
| 2 | Commit to git | `git add & commit` | ⬜ |
| 3 | Push to origin/main | `git push origin main` | ⬜ |
| 4 | Delete incomplete release | `gh release delete v1.17.7 --yes` | ⬜ |
| 5 | Create git tag | `git tag -a v1.17.7 -m "..."` | ⬜ |
| 6 | Push git tag | `git push origin v1.17.7` | ⬜ |
| 7 | Monitor CI/CD | Check GitHub Actions (10-15 min) | ⬜ |
| 8 | Verify completion | Run `gh release view v1.17.7` | ⬜ |
...
1. **Update `.github/workflows/release-on-tag.yml`** (for v1.17.8+):
...
4. **Update UNIFIED_WORK_PLAN.md**:
   ...
   - Recommended process for v1.17.8+
...
✅ GitHub release v1.17.7 shows 276+ line release notes
