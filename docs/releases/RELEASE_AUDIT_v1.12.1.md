...
2. ✅ **Install Inno Setup** - v1.12.1 detected (pre-installed on runner)
...
### 5. **Documentation**
- ✅ CI/CD Pipeline Guide updated to v1.12.1
...
4. Create v1.12.1 with corrected workflow
...
- RELEASE_COMPLETE_v1.12.1.md - v1.12.1 completion report
