...
| Metric | $11.17.6 (Baseline) | $11.17.6 (Current) | Improvement |
|--------|-------------------|-------------------|-------------|
...
*Note: $11.17.6 uses `useVirtualScroll` to render only visible items + overscan buffer.*

### 2. Interaction Latency

| Interaction | $11.17.6 | $11.17.6 | Notes |
|-------------|---------|---------|-------|
