...
| Version format | ✅ `vvvvv1.18.25` (valid) |
...
| `4688e4cc5` | chore(docs): record vvvvv1.18.25 publication verification evidence |
...
- ✅ Tag `vvvvv1.18.25` created and pushed (`2026-03-21`)
