...
| Version format | ✅ `vvvv1.18.24` (valid) |
...
| `4688e4cc5` | chore(docs): record vvvv1.18.24 publication verification evidence |
...
- ✅ Tag `vvvv1.18.24` created and pushed (`2026-03-21`)
