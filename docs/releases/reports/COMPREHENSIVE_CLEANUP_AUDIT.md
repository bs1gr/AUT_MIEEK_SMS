...
**Status:** 🔍 In Progress
**Objective:** Identify all cleanup candidates before $11.13.0 major release
...
- **Purpose:** Archive legacy GitHub releases (pre-$11.13.0?)
- **Dependency:** Likely requires `scripts/ops/archive-releases.ps1`
- **Usage:** Manual dispatch for archival operations
- **Recommendation:** **DEPRECATE** after $11.13.0 release archival complete
- **Action:** Execute once for $11.13.0, then archive this workflow
...
- **Recommendation:** **REMOVE** in $11.13.0 (breaking change - document in CHANGELOG)
- **Affected Docs:**
...
- **Recommendation:** **REMOVE** entire directory in $11.13.0
...
- **Recommendation:** **KEEP** for $11.13.0 archival, then **ARCHIVE** script itself
...
**Good News:** Pre-$11.13.0 scripts already archived:
...
**Files:**
- `RELEASE_NOTES_$11.13.0.md`
- `RELEASE_NOTES_$11.13.0.md`
- `RELEASE_NOTES_$11.13.0.md`
- `RELEASE_NOTES_$11.13.0.md`
- `RELEASE_NOTES_$11.13.0.md`
- `RELEASE_NOTES_$11.13.0.md`
- `GITHUB_RELEASE_$11.13.0.md`
- `GITHUB_RELEASE_$11.13.0.md`
- `RELEASE_SUMMARY_$11.13.0.md`
- `RELEASE_SUMMARY_$11.13.0.md`
- `VERSION_1.12.8_TECHNICAL_SUMMARY.md`
- `$11.13.0.md`, `$11.13.0.md`

**Recommendation:**
- ✅ **KEEP** all recent release notes (v1.12.x series)
- ⚠️ **CONSOLIDATE** pre-$11.13.0 release notes into:
  - `docs/archive/releases/PRE_$11.13.0_RELEASE_NOTES.md` (already planned in cleanup plan)
...
**Recommendation:**
```
- Keep: Last 3 releases ($11.13.0, $11.13.0, $11.13.0)
...
### Phase 3: Code Deprecation Removal (Breaking Changes - $11.13.0)
...
### Phase 4: Workflow & Documentation Consolidation (Post-$11.13.0)

#### 4.1 Workflow Decisions
**Execute after $11.13.0 release:**
```bash
...
```powershell
# Consolidate pre-$11.13.0 release notes
# (Already planned in MAJOR_RELEASE_PREPARATION_PLAN.md)

# Create: docs/archive/releases/PRE_$11.13.0_RELEASE_NOTES.md
...
- 🔴 Remove `backend.auto_import_courses` and `backend.tools`
  ...
  - **Mitigation:** Version as $11.13.0 (major version), document in CHANGELOG, provide migration guide
...
### Phase 3: Breaking Changes ($11.13.0)
...
2. **User decisions needed:**
   ...
   - Approve breaking changes for $11.13.0
3. **Execute Phase 1** - Low-risk cleanup (no approval needed)
4. **Plan Phase 2-5** - Schedule with $11.13.0 release

**Timeline:**
- **Phase 1:** Immediate (5 minutes)
- **Phase 2:** After user approval (30 minutes)
- **Phase 3:** With $11.13.0 version bump (1 hour)
- **Phase 4:** Post-$11.13.0 release (1 hour)
...
- [IMPROVEMENTS_$11.13.0_to_$11.13.0.md](IMPROVEMENTS_$11.13.0_to_$11.13.0.md)
