# CI/CD Release Workflow Audit - $11.17.7

**Date**: February 3, 2026
**Audit Focus**: GitHub release $11.17.7 publication failure analysis
...
The GitHub release $11.17.7 was created but **published incomplete**:
- ❌ No assets attached (installer, Docker images, documentation)
- ❌ Minimal release body ("Release $11.17.7" instead of comprehensive notes)
...
**Symptom**:
- GitHub release body shows: `Release $11.17.7` (fallback text)
- Expected body: 276+ lines of comprehensive release notes
- Actual file: `docs/releases/RELEASE_NOTES_$11.17.7.md` (✅ exists, 276 lines)
...
Workflow looks for: `.github/RELEASE_NOTES_$11.17.7.md`
Actual file location: `docs/releases/RELEASE_NOTES_$11.17.7.md`
...
git commit -m "docs(release): sync $11.17.7 release notes to .github/ for CI/CD"
```
...
```bash
# What happened:
gh release create $11.17.7 --title "Release $11.17.7" --notes "Release $11.17.7"
...
6. Complete release with:
   ...
   - Installer attachment (SMS_Setup_$11.17.7.exe)
...
- `SMS_Setup_$11.17.7.exe` (Windows installer)
...
**Impact**:
- Users cannot pull Docker image for $11.17.7
...
```
✅ docs/releases/RELEASE_NOTES_$11.17.7.md (276 lines) - CREATED
✅ docs/releases/GITHUB_RELEASE_$11.17.7.md - CREATED
...
```
❌ Release notes at .github/RELEASE_NOTES_$11.17.7.md - NOT COPIED
...
docs/releases/RELEASE_NOTES_$11.17.7.md (276 lines, comprehensive)
docs/releases/GITHUB_RELEASE_$11.17.7.md (template for body)

# Task 2: Copy release notes to CI/CD location (NEW - REQUIRED)
Copy-Item "docs/releases/RELEASE_NOTES_$11.17.7.md" ".github/RELEASE_NOTES_$11.17.7.md"

# Task 3: Commit both files
git add docs/releases/RELEASE_NOTES_$11.17.7.md
git add .github/RELEASE_NOTES_$11.17.7.md
git commit -m "docs(release): prepare $11.17.7 release documentation"
git push origin main

# Task 4: Create and push git tag (TRIGGERS CI/CD)
git tag -a $11.17.7 -m "Release $11.17.7"
...
**Triggered By**: `git push origin $11.17.7`

**Job 1: `release-on-tag.yml` → `create-release`**
```
Inputs: Tag name ($11.17.7) from git push
Steps:
  1. Checkout repository
  2. Extract tag name
  3. Read release notes from .github/RELEASE_NOTES_$11.17.7.md ✅ (fixed path)
...
Steps:
  ...
  4. Resolve release ID for $11.17.7
...
Output:
  - SMS_Setup_$11.17.7.exe attached to release
...
gh release view $11.17.7 --json body,assets,isDraft,isPrerelease
...
gh release download $11.17.7 --pattern "*.exe"
certUtil -hashfile SMS_Setup_$11.17.7.exe SHA256
...
## Action Plan to Fix $11.17.7 Release
...
Copy-Item `
  "docs/releases/RELEASE_NOTES_$11.17.7.md" `
  ".github/RELEASE_NOTES_$11.17.7.md"
...
git tag -a $11.17.7 -m "Release $11.17.7 - Maintenance and internationalization improvements"
...
- Copy RELEASE_NOTES_$11.17.7.md to .github/ directory
...
### 2. `.github/RELEASE_NOTES_$11.17.7.md`

**Status**: NEEDS TO BE CREATED

**Source**: Copy from `docs/releases/RELEASE_NOTES_$11.17.7.md`
...
**Release $11.17.7 Will Be Complete When**:

✅ GitHub release body contains 276+ lines of release notes
✅ Installer asset (SMS_Setup_$11.17.7.exe) attached to release
...
gh release view $11.17.7 --json body,assets,isDraft,isPrerelease,createdAt,publishedAt
...
## Lessons Learned & Prevention for $11.17.7+
...
1. ✅ Create release notes at BOTH locations:
   - `docs/releases/RELEASE_NOTES_$11.17.7.md` (single source of truth)
   - `.github/RELEASE_NOTES_$11.17.7.md` (CI/CD input)
...
- `docs/releases/RELEASE_NOTES_$11.17.7.md` (276 lines) - Comprehensive notes
- `docs/releases/GITHUB_RELEASE_$11.17.7.md` - GitHub template
...
**Next Steps**: Execute action plan steps 1-5 above to complete $11.17.7 release properly.
