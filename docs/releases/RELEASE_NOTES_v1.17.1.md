...
v1.18.3 is a critical bugfix release that resolves a schema validation issue discovered in v1.18.3 testing. All backend tests verified passing (100% success rate, 16/16 batches).
...
✅ **Fully compatible** with v1.18.3 and earlier versions.
...
- No performance changes from v1.18.3
...
docker run -d -p 8080:8080 bs1gr/sms:v1.18.3
...
**v1.18.3** (Jan 12, 2026) - Bugfix: Missing RBAC schema exports ✅
**v1.18.3** (Previous) - Real-Time Notifications system

---

## Support

For issues or questions about v1.18.3:
