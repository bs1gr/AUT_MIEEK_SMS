# Release Notes v1.18.3 - Test Fixes & Documentation Updates
...
This patch release addresses test failures introduced by the auto-activation UI enhancements in v1.18.3 and updates release documentation to properly reflect the new features.
...
### Documentation
- **releases**: update v1.18.3 documentation to include auto-activation features
...
- Frontend and backend compatible with v1.18.3
...
- Parent release: [v1.18.3](RELEASE_NOTES_v1.18.3.md)
- Auto-activation feature: Implemented in v1.18.3
