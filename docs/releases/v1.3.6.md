...
This release focuses on operational hardening (automated and safe database migrations), CI and developer ergonomics (type checking and dev dependency management), and small repo hygiene improvements. This is a minor revision to resolve release conflicts and consolidate release artifacts.
...
1. This release replaces the earlier v1.3.5 release notes to resolve naming conflicts in GitHub Releases. Please publish as tag `v1.3.6`.
...
1. Publish this release in GitHub Releases using tag `v1.3.6` and paste this release body.
