...
**Content**:
- Version releases: v1.12.x through v1.18.3 documented
...
- Next scheduled releases (v1.18.3+ staging, v1.18.3 Phase 2)
...
- [x] All version releases documented (v1.12.x - v1.18.3)
