...
**Baseline**: v1.18.3 (December 11, 2025)
...
- CHANGELOG entry (comprehensive v1.18.3 section)
...
- **New Tests**: 290+ test cases for v1.18.3 features
...
- Review [ROADMAP_v1.18.3.md](ROADMAP_v1.18.3.md) for feature details
- See [copilot-instructions.md](.github/copilot-instructions.md) for development setup

### For Issues

- Report bugs on GitHub Issues with version tag `v1.18.3`
