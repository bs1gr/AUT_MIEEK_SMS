...
**Official Release Context**: `v1.18.25` is now the live/latest first official public release.

### Commit Categories

| Category | Count | Scope |
|----------|-------|-------|
| Corrective Release Prep | 1 | verified `v1.18.25` release packaging |
...
- [ ] `VERSION` file contains `v1.18.25`
...
- [ ] GitHub Release page published at `/releases/tag/v1.18.25`
