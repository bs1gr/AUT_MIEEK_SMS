...
- [x] Version metadata aligned to `v1.18.25`
...
- [x] Local installer build/sign/smoke for `v1.18.25`
- [x] Tag `v1.18.25` created and pushed
...
- [x] Release page published: `https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.18.25`
