...
- [ ] Release docs prepared:
  - [x] `RELEASE_NOTES_v1.18.25.md`
  - [x] `GITHUB_RELEASE_v1.18.25.md`
  - [x] `RELEASE_MANIFEST_v1.18.25.md`
  - [x] `.github/RELEASE_NOTES_v1.18.25.md`

## Tag & Release Execution

- [x] Create and push tag `v1.18.25` from `main`.
- [x] Confirm `release-on-tag.yml` started.
- [x] Confirm release body was created/updated from `.github/RELEASE_NOTES_v1.18.25.md`.
...
- [x] Prior stable tag recorded (`v1.18.25`).
- [x] No legacy-tag workflow re-dispatch actions performed.

## Workflow Evidence (v1.18.25)
...
- Release URL: `https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.18.25`
