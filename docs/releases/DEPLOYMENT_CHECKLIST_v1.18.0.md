...
- [ ] Tag does **not** already exist before release creation (`$11.18.1`)
...
- [ ] `CHANGELOG.md` contains post-`$11.18.1` consolidated release notes
- [ ] `RELEASE_NOTES_$11.18.1.md` updated
- [ ] `GITHUB_RELEASE_$11.18.1.md` updated
- [ ] `RELEASE_MANIFEST_$11.18.1.md` updated
...
- [ ] Create GitHub release using `GITHUB_RELEASE_$11.18.1.md`
