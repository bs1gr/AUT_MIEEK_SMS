...
b43a085e8 docs: update CHANGELOG and work plan with post-v1.18.25 development history
...
bb57c51c2 feat(release): add v1.18.25 verification script and update work plan
```
