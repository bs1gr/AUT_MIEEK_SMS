...
b43a085e8 docs: update CHANGELOG and work plan with post-vvv1.18.22 development history
...
bb57c51c2 feat(release): add vvv1.18.22 verification script and update work plan
```
