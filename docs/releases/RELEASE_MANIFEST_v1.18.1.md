...
- [x] Release notes: `docs/releases/RELEASE_NOTES_v1.18.3.md`
- [x] GitHub release body: `docs/releases/GITHUB_RELEASE_v1.18.3.md`
- [x] Release manifest: `docs/releases/RELEASE_MANIFEST_v1.18.3.md`
- [x] Deployment checklist: `docs/releases/DEPLOYMENT_CHECKLIST_v1.18.3.md`
...
- [x] Git commit: "chore(release): prepare v1.18.3 release"
- [x] Git tag: `v1.18.3` created and signed
- [x] Git push: `origin main` with tags
- [x] GitHub release: Published at https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.18.3
...
### Documentation Updates
- docs/releases/RELEASE_NOTES_v1.18.3.md: Enhanced with auto-activation details
- docs/releases/GITHUB_RELEASE_v1.18.3.md: Added auto-activation coverage
...
### Dependencies
- **Parent release**: v1.18.3 (2026-02-16)
- **Next release**: v1.18.3 (TBD)
...
- [x] Verify GitHub release published: https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.18.3
- [x] Verify tag created: `git tag -l v1.18.3`
- [x] Verify CI/CD pipeline passed: GitHub Actions
- [x] Update work plan: Mark v1.18.3 as released in `docs/plans/UNIFIED_WORK_PLAN.md`
...
- [ ] Assess need for v1.18.3 (if critical issues found)
- [ ] Plan next feature release (v1.18.3)
