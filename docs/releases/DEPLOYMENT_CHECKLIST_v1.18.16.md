...
- [ ] Confirm `VERSION` file reads `v1.18.16`
...
### 3. Upgrade from v1.18.15

- [ ] Stop Docker if running: `.\DOCKER.ps1 -Stop`
- [ ] Run installer: `SMS_Installer_1.18.16.exe`
- [ ] Upgrade path: v1.18.15 -> v1.18.16 (no database migration required)
- [ ] Accept UAC prompt
...
- [ ] `git checkout v1.18.16` (or keep `main`)
