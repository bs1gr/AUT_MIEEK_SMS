...
**Release Title**: v1.17.6 - Internationalization & Deployment Reliability Improvements
...
**v1.17.6** is a maintenance and enhancement release focused on internationalization improvements for Greek locale support, Docker deployment reliability enhancements, and historical data editing capabilities.
...
- **Release Notes**: [docs/releases/RELEASE_NOTES_v1.17.6.md](https://github.com/bs1gr/AUT_MIEEK_SMS/blob/main/docs/releases/RELEASE_NOTES_v1.17.6.md)
...
- `380c46abf` - docs(plan): Update work plan - v1.17.6 release preparation complete
- `d722a3028` - docs: Add v1.17.6 release notes and fix markdown table formatting
...
[View all commits since v1.17.6](https://github.com/bs1gr/AUT_MIEEK_SMS/compare/v1.17.6...v1.17.6)
