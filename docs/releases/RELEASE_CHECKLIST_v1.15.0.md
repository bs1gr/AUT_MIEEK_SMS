...
**URL**: https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.15.0
...
For future releases (v1.16.0+), use one of these methods:
...
- [ ] Update project board with v1.15.0 completion
...
- [ ] Document any issues for v1.16.0
...
- [ ] Tagged as v1.15.0 and marked "Latest"
...
|------|-----------|--------|
| Jan 5, 2026 | Code released (v1.15.0) | ✅ Complete |
...
| Feb/Mar 2026 | v1.16.0 Release | 📋 Planned |
