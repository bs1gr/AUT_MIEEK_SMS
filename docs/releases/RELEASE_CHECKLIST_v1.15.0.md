...
- [x] Release notes created ([RELEASE_NOTES_v1.18.3.md](RELEASE_NOTES_v1.18.3.md))
- [x] GitHub release draft prepared ([GITHUB_RELEASE_v1.18.3.md](GITHUB_RELEASE_v1.18.3.md))
...
3. **Copy Release Body**
   - [ ] Open: `docs/releases/GITHUB_RELEASE_v1.18.3.md`
...
- [ ] Create feature branch: `feature/v1.18.3-phase2`
