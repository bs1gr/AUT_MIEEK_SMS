...
| `38f2e39e1` | chore(release): record v1.18.25 publication evidence |
...
- ✅ Commit `c1e576e44` (`chore(release): prepare v1.18.25`) pushed to `main`
- ✅ Tag `v1.18.25` created and pushed (`2026-04-08`)
