...
| `38f2e39e1` | chore(release): record vvvvv1.18.25 publication evidence |
...
- ✅ Commit `c1e576e44` (`chore(release): prepare vvvvv1.18.25`) pushed to `main`
- ✅ Tag `vvvvv1.18.25` created and pushed (`2026-04-08`)
