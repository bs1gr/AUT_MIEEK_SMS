# Major Release Preparation Plan v1.13.0

**Created:** 2025-12-29
**Target Release:** v1.13.0 (Next Major Release)
...
1. **Comprehensive Improvement Report** - Document all enhancements from v1.12.0 to v1.12.9
...
5. **Fresh Baseline** - Establish v1.13.0 as clean starting point for future development
...
- v1.12.9 (Latest - published ~1 hour ago)
- v1.12.8, v1.12.7, v1.12.6, v1.12.5, v1.12.3, v1.12.2, v1.12.1
- v1.11.2, v1.11.1, v1.11.0
- v1.10.1, v1.10.0
- v1.9.10, v1.9.9, v1.9.8, v1.9.7, v1.9.4, v1.9.3

**Draft Releases (CLEANUP CANDIDATES):**
- ❌ v1.12.9 (Draft - duplicate, published ~1 hour ago)
- ❌ v1.12.8 (Draft - duplicate)
- ❌ v1.12.7 (Draft - duplicate)
...
**Create:** `docs/releases/reports/IMPROVEMENTS_v1.12.0_to_v1.12.9.md`

**Content Sections:**
1. **Executive Summary**
   - Version progression: v1.12.0 → v1.12.9
...
- Git log: `git log v1.12.0..v1.12.9 --oneline`
- GitHub PR history
...
gh release delete v1.12.9 --yes  # Draft only, keep published
...
- **Documentation:** Create `docs/archive/releases/PRE_v1.12.0_RELEASES.md`
...
- **Gitignore:** Ensure `test-results/` is gitignored (already added in v1.12.9)
...
Move-Item -Path ".\start-backend.ps1" -Destination ".\archive\pre-v1.9.1\start-backend.ps1"
```
...
1. **`docs/archive/releases/PRE_v1.12.0_RELEASES.md`**
...
2. **`docs/archive/reports-2025-12/WORKSPACE_CLEANUP_v1.13.0_PRE_RELEASE.md`**
   - Document what was cleaned up before v1.13.0
...
### Task 3.1: Version Bump to v1.13.0
**Files to Update:**
...
**Current Issue:** CHANGELOG.md has duplicate entries for v1.12.9

**Actions:**
1. Deduplicate v1.12.9 entries (merge into single section)
2. Add v1.13.0 section at top:
   ```markdown
   ## [1.13.0] - 2025-12-29
   ...
   **Focus:** Comprehensive improvement report, archival cleanup, fresh baseline
   ...
   - Release archival documentation for pre-v1.12.0 versions
   ...
   - Duplicate GitHub draft releases (v1.12.9, v1.12.8, v1.12.7 drafts)
   - Test tag v-test-1
...
**File:** `docs/releases/reports/RELEASE_REPORT_v1.13.0.md`
...
1. **Release Summary**
   ...
   - Upgrade Path: v1.12.9 → v1.13.0 (no breaking changes)
...
5. **Next Steps**
   - v1.13.1+ roadmap (Phase 2.4 RBAC if planned)
...
**Expected Outputs:**
- Git tag `v1.13.0` created and pushed
...
### GitHub Cleanup
- Draft releases deleted: 4 (v1.12.9, v1.12.8, v1.12.7, pr-45-load-report)
- Test tags deleted: 1 (v-test-1)
- Archived documentation: Pre-v1.12.0 release history
...
$backupDir = ".\pre-v1.13.0-backup-$timestamp"
...
2. **Delete Tag:** `git tag -d v1.13.0 && git push origin :refs/tags/v1.13.0`
3. **Delete Release:** `gh release delete v1.13.0 --yes`
4. **Restore Backup:** Copy files from `pre-v1.13.0-backup-*/`

### User Approval Required
**Before executing these destructive actions, confirm with user:**
- [ ] Delete GitHub draft releases (v1.12.9, v1.12.8, v1.12.7, pr-45 drafts)
...
4. Should v1.13.0 be the version, or would you prefer v2.0.0 for a major consolidation?
