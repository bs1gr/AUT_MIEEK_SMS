# SMS vvv1.18.25 - Final Release Summary
...
- **RELEASE_vvv1.18.25_FINAL.md** - This file
...
| Version showing vvv1.18.25 | ✅ FIXED | Corrected PyInstaller spec file naming |
...
```
52773938c chore(release): Add SMS_Lite.exe vvv1.18.25 executable
...
SMS vvv1.18.25 is a **production-ready release** with all critical bugs fixed. The QNAP PostgreSQL integration is now fully functional, and the installer provides a seamless setup experience for both Docker and Lite Edition deployments.
