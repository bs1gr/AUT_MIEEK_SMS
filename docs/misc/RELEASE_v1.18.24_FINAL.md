# SMS v1.18.25 - Final Release Summary
...
- **RELEASE_v1.18.25_FINAL.md** - This file
...
| Version showing v1.18.25 | ✅ FIXED | Corrected PyInstaller spec file naming |
...
```
52773938c chore(release): Add SMS_Lite.exe v1.18.25 executable
...
SMS v1.18.25 is a **production-ready release** with all critical bugs fixed. The QNAP PostgreSQL integration is now fully functional, and the installer provides a seamless setup experience for both Docker and Lite Edition deployments.
