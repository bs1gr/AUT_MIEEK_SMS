...
$backupPath = "d:\SMS\student-management-system\backups\pre_v1.18.3_$timestamp.db"
...
Test-Path docs/deployment/STAGING_DEPLOYMENT_PLAN_v1.18.3.md
# Expected: Both return True
...
- Deployment plan: `docs/deployment/STAGING_DEPLOYMENT_PLAN_v1.18.3.md`
