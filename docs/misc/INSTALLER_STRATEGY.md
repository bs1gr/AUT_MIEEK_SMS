# SMS Installer Strategy - v1.18.25
...
```
╔════════════════════════════════════════════╗
║   SMS Student Management System v1.18.25   ║
║              Installation Wizard           ║
╚════════════════════════════════════════════╝
...
unzip SMS_Installer_v1.18.25.zip
cd SMS_Installer_v1.18.25/docker
...
### Lite Package
```
File: SMS_Native_Lite_v1.18.25.zip
...
### Combined Installer
```
File: SMS_Installer_v1.18.25.exe
...
```
User Experience:
  1. Download SMS_Installer_v1.18.25.exe
  2. Run installer
...
For IT teams who know Docker:
  1. Download SMS_Docker_v1.18.25.zip
  2. Extract files
  3. Run setup.sh
...
For portable/standalone use:
  1. Download SMS_Native_Lite_v1.18.25.zip
...
|-----------|---------|--------|
| SMS Backend | v1.18.25 | Ready |
| SMS Frontend | v1.18.25 | Ready |
| Docker Config | v1.18.25 | Ready |
| Native Lite Exe | 67.1 MB | Ready |
| Installer Wizard | v1.18.25 | Design |
| Documentation | v1.18.25 | Complete |
...
*SMS Installer Strategy v1.18.25 - Docker & Lite Only*
