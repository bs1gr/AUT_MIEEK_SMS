-
### Scenario 2: Repair v1.18.3 → v1.18.3
**Status**: ⚠ Partial
**Date Started**: Feb 5, 2026
**Date Completed**: Feb 5, 2026
**Tester Notes**: Running the installer again detected the existing v1.18.3 instance and immediately proceeded into a reinstall/repair flow. There was no explicit "Remove" option in the dialog, so uninstall could not be invoked from this path. Post-install backup directory received a new timestamped folder, but it did not include the database or `.env` copies as expected.

Key Checks Completed:
- [x] Installer detected existing v1.18.3 install
...
# Installer Testing Tracker - v1.18.3

**Created**: February 5, 2026
**Installer Version**: 1.17.7
**Installer Location**: [GitHub Release v1.18.3](https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.18.3)
...
1. Go to: https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.18.3
...
| 3 | **Upgrade v1.18.3 → v1.18.3** | ⬜ Not Started | - | - | In-place upgrade test | - |

### Priority 2: Edge Cases (Execute After Priority 1)

| # | Scenario | Status | Date | Duration | Notes | Issues Found |
|---|----------|--------|------|----------|-------|--------------|
| 2 | **Repair v1.18.3** | ⚠ Partial | Feb 5, 2026 | ≈15m | Repair succeeded but no "Remove" option and backup missing .env/db files | Issue #4 |
...
### Scenario 3: Upgrade v1.18.3 → v1.18.3
**Status**: ⬜ Not Started
**Date Started**: -
**Date Completed**: -
**Tester Notes**:
...
1. **Download installer**: GitHub Release v1.18.3
