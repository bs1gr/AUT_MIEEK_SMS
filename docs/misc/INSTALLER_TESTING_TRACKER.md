-
### Scenario 2: Repair $11.18.3 → $11.18.3
**Status**: ⚠ Partial
**Date Started**: Feb 5, 2026
**Date Completed**: Feb 5, 2026
**Tester Notes**: Running the installer again detected the existing $11.18.3 instance and immediately proceeded into a reinstall/repair flow. There was no explicit "Remove" option in the dialog, so uninstall could not be invoked from this path. Post-install backup directory received a new timestamped folder, but it did not include the database or `.env` copies as expected.

Key Checks Completed:
- [x] Installer detected existing $11.18.3 install
...
# Installer Testing Tracker - $11.18.3

**Created**: February 5, 2026
**Installer Version**: 1.17.7
**Installer Location**: [GitHub Release $11.18.3](https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/$11.18.3)
...
1. Go to: https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/$11.18.3
...
| 3 | **Upgrade $11.18.3 → $11.18.3** | ⬜ Not Started | - | - | In-place upgrade test | - |

### Priority 2: Edge Cases (Execute After Priority 1)

| # | Scenario | Status | Date | Duration | Notes | Issues Found |
|---|----------|--------|------|----------|-------|--------------|
| 2 | **Repair $11.18.3** | ⚠ Partial | Feb 5, 2026 | ≈15m | Repair succeeded but no "Remove" option and backup missing .env/db files | Issue #4 |
...
### Scenario 3: Upgrade $11.18.3 → $11.18.3
**Status**: ⬜ Not Started
**Date Started**: -
**Date Completed**: -
**Tester Notes**:
...
1. **Download installer**: GitHub Release $11.18.3
