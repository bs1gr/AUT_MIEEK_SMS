# Phase 3: Final Release Preparation - v1.18.25 Installer
...
Phase 3 is the final step to release-ready v1.18.25 Windows Installer. 
...
### Test Scenario 3: Upgrade from v1.18.25

**Steps:**
1. Have v1.18.25 installed from previous installer
2. Run new `SMS_Installer_1.18.24.exe`
3. Installer detects v1.18.25
...
### Upload Installer to v1.18.25 Release

**Current Status:**
- ✅ v1.18.25 tag created
- ✅ v1.18.25 release page exists
...
gh release upload v1.18.25 .\dist\SMS_Installer_1.18.24.exe

# Verify
gh release view v1.18.25
```

**Option B: Using GitHub Web Interface**

1. Go to: https://github.com/bs1gr/AUT_MIEEK_SMS/releases/tag/v1.18.25
...
- [ ] Installer uploaded to v1.18.25 release
...
4. File is uploaded to GitHub v1.18.25 release
...
- [Windows Installer Review](INSTALLER_REVIEW_v1.18.25.md)
