# SMS v1.18.25 Installer - Testing & Deployment Index
...
2. Push tag: `git push origin v1.18.25`
...
- **Test 1.2:** Upgrade from v1.18.25 ✅
...
The SMS v1.18.25 installer is **FULLY TESTED AND PRODUCTION READY**.
