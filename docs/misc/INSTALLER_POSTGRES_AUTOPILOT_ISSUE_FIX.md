...
**Issue**: Latest installer ($11.18.3) defaults to PostgreSQL + Docker Compose, causing fresh installs to fail with "Failed to start Docker Compose stack"
...
- **$11.18.3**: ❌ Contains the issue (from commit 2a3e64704 onward)
- **$11.18.3**: ✅ Uses fullstack image (no compose auto-routing)
- **$11.18.3 and earlier**: ✅ Uses fullstack image
...
3. **Update installer** with next release ($11.18.3 or $11.18.3)
