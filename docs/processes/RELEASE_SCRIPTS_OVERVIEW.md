...
**Created**: Previous session ($11.15.0 era)
...
.\RELEASE_HELPER.ps1 -Action CreateRelease -Tag $11.15.0  # Custom version
```
...
**Purpose**: One-off script to update $11.15.0 GitHub Release
**Created**: January 6, 2026 (this session)
**Scope**: Single-use for $11.15.0 only

**What it does**:
- Hardcoded to update $11.15.0 specifically
- Extracts release body from `GITHUB_RELEASE_$11.15.0.md`
...
# Then manually:
.\RELEASE_HELPER.ps1 -Action CreateRelease -Tag $11.15.0  # Publish GitHub Release
```
...
git commit -m "docs: release notes for $11.15.0"
...
# - Create docs/releases/RELEASE_NOTES_$11.15.0.md
# - Create docs/releases/GITHUB_RELEASE_$11.15.0.md
# - Update CHANGELOG.md
...
|---------|----------------------|-------------------|-------------------|
| **Purpose** | Full release automation | Post-release GitHub UI | One-time $11.15.0 update |
...
| **Updates GitHub Release** | ❌ No | ✅ Yes | ✅ Yes ($11.15.0 only) |
| **Interactive** | ❌ No | ✅ Yes | ❌ No |
| **Reusable** | ✅ Yes | ✅ Yes | ❌ No ($11.15.0 only) |
...
```powershell
# Old way (UPDATE_RELEASE.ps1 - hardcoded $11.15.0):
.\UPDATE_RELEASE.ps1
...
**Create GitHub Release**: `.\RELEASE_HELPER.ps1 -Action CreateRelease -Tag $11.15.0`

**Update existing GitHub Release**: `.\RELEASE_HELPER.ps1 -Action CreateRelease -Tag $11.15.0` (detects existing)

**Create Phase 2 issues**: `.\RELEASE_HELPER.ps1 -Action CopyIssue`

---

## 🎯 Recommended Workflow for $11.15.0+
...
**See Also**:
- [Release Checklist Template](../releases/RELEASE_CHECKLIST_$11.15.0.md)
- [GitHub Release Template](../releases/GITHUB_RELEASE_$11.15.0.md)
