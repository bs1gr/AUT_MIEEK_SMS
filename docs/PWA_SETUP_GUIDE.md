...
frontend/public/screenshot-540x720.png ✅
frontend/public/screenshot-1280x720.png ✅
...
3. **Enable offline:**
   ...
   - Settings → Developer Options → Offline mode
...
3. **Test offline:**
   - Settings → WiFi & Bluetooth: Turn both off
...
# ✅ Offline toggle should be available

# Check cache registration

# DevTools → Application → Cache Storage
# ✅ Should see precache-v1, api-cache, fonts-cache
...
# Console should show "🔄 App update available"
