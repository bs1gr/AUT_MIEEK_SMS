...
After implementing the RBAC module (v1.18.3+) and Advanced Search module (v1.18.3+), several Greek localization (EL) issues emerged:
...
4. **Deprecated keys still being used** in components (from v1.18.3 era)
...
**BUT**: Some keys used in newer components (after v1.18.3) are not found:
