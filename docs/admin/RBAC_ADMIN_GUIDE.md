...
This guide covers Role-Based Access Control (RBAC) administration for SMS v1.18.3+. It explains how permissions work, how to assign them, and how to troubleshoot access issues.
