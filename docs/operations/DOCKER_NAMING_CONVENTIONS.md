...
```text
sms_data_rebuild_v1.18.3_20251029_143022
sms_data_rebuild_v1.18.3_20251029_150845
sms_data_rebuild_v1.18.3_20251030_091234

```text
**Components:**

- `sms_data_rebuild` - Indicates volume created via rebuild process
- `v[VERSION]` - App version when volume was created (e.g., v1.18.3)
...
```text
sms_backup_v1.18.3_20251029_143022.db
sms_backup_v1.18.3_20251029_150845.db
sms_backup_v1.18.3_20251030_091234.db

```text
**Components:**

- `sms_backup` - Indicates database backup file
- `v[VERSION]` - App version at backup time (e.g., v1.18.3)
...
✓ New volume configured: sms_data_rebuild_v1.18.3_20251029_143022
...
Creating backup from Docker volume...
  Target: sms_backup_v1.18.3_20251029_143022.db

✓ Backup created successfully (188.45 KB)
  Location: backups\sms_backup_v1.18.3_20251029_143022.db
...
- New volume (if selected): `sms_data_rebuild_v1.18.3_20251029_153045`
- Old v1.18.3 images and volumes remain for rollback
...
# Volume: sms_data_rebuild_v1.18.3_20251029_143022

# Step 1: Create backup before upgrade

.\SMS.ps1  # Option B - Backup
# Creates: sms_backup_v1.18.3_20251029_150000.db
...
# - Same volume: sms_data_rebuild_v1.18.3_20251029_143022 (data preserved)
...
# Test v1.18.3, if issues found:

echo "1.1.0" > VERSION
docker compose down
docker compose up -d
# Back to stable v1.18.3
...
docker volume rm student-management-system_sms_data_rebuild_v1.18.3_20251020_120000

# Remove specific backup

Remove-Item .\backups\sms_backup_v1.18.3_20251020_120000.db
...
| Rebuild all | `.\SMS.ps1` → X | `sms-backend:1.1.0`<br>`sms-frontend:1.1.0`<br>`sms_data_rebuild_v1.18.3_20251029_143022` |
| Backup DB | `.\SMS.ps1` → B | `sms_backup_v1.18.3_20251029_143022.db` |
