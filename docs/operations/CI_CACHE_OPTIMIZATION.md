...
> Note: The Playwright cache key was updated to a dynamic version-based strategy in $11.18.3. Post-change monitoring aims to raise Playwright hit rate to ≥60–70% and reduce install time variance.
...
## Post-change validation ($11.18.3)
