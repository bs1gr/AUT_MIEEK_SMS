...
All legacy scripts are consolidated in v1.18.3. Use only the canonical entry points (`DOCKER.ps1`, `NATIVE.ps1`).
...
- **v1.18.3** (January 2025): Scripts consolidated to DOCKER.ps1 and NATIVE.ps1
- **v1.18.3** (November 2025): Legacy scripts archived
- **v1.18.3+** (October 2025): Scripts reorganized into dev/ and deploy/
- **v1.18.3** (September 2025): Introduced SMART_SETUP.ps1 and SMS.ps1
- **v1.18.3** (August 2025): Added Docker volume versioning
- **v1.18.3** (July 2025): Initial release
