# SMS Installer v1.18.24 - Real Test Report
...
The SMS v1.18.24 installer has been built and verified:
...
```
Prerequisites:
- v1.18.9 or earlier already installed

Steps:
1. [ ] Run v1.18.24 installer as Administrator
