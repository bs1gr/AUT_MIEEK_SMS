...
| 2 | Upgrade Same Version ($11.18.3 → $11.18.3 Repair) | Repair | 5-10 min | $11.18.3 installed | ⏳ Ready |
| 3 | Upgrade from $11.18.3 → $11.18.3 | Upgrade | 10-15 min | $11.18.3 installed | ⏳ Ready |
...
| 6 | Uninstall with Data Preservation | Uninstall | 5-10 min | $11.18.3 installed | ⏳ Ready |
...
- **Location**: GitHub Release $11.18.3 (pre-built, available for download)
- **Verification**:
...
1. **Download Installer**: Get `SMS_Installer_1.17.7.exe` from GitHub Release $11.18.3
...
- **Version**: $11.18.3 production live ✅
...
1. **Option 1: Maintenance & Stability**
   ...
   - Monitor production $11.18.3 (2-4 weeks)
