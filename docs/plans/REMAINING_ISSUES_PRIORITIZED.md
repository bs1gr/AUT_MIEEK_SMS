...
**Current State**:
- ✅ v1.15.0 released (January 5, 2026)
...
4. ⏳ **TODO**: Tag as v1.15.0 (targeting main branch)
...
3. Assign to milestones (v1.16.0)
...
**Release** (1 issue):
- #80: v1.16.0 Release preparation
...
3. Establish performance baselines (from v1.15.0 optimizations)
...
**Status**: ✅ Mostly complete (from v1.14.0)
...
**For Project Lead**:
1. Create GitHub Release for v1.15.0 (15 minutes)
