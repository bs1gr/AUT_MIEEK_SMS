...
- Task: "Backend test reconciliation"
  ...
  Links: "docs/TEST_FAILURE_PATTERNS.md, docs/releases/v1.14.2_test_status.md"
```
...
- Task: "Backend test reconciliation"
  Status: "blocked"
  Blocker: "Cannot determine if failures are pre-existing or new (no baseline test run from v1.14.2 release)"
