...
> **⚠️ DEPRECATED (v1.18.3):** This document references `backend.auto_import_courses` which was removed in v1.18.3. See [Migration Guide](../../guides/MIGRATION_v1.18.3.md) for updated import paths.
...
- **v1.18.3 (Now):** Both import paths work, deprecation warnings shown
- **v1.18.3+:** Enhanced diagnostics if old paths used
- **v1.18.3+:** Possible removal of old import stubs (with notice period)
...
| **TOTAL** | **13.5** | **2/5 Complete** | **v1.18.3-ready** |
