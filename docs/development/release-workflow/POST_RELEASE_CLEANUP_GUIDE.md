...
```
RELEASE_NOTES_$11.13.0.md → docs/releases/
```
...
```
GITHUB_RELEASE_$11.13.0.md → docs/releases/
```
...
# 5. Commit
git add -A
git commit -m "chore: post-release cleanup for $11.13.0"
...
├── docs/
│   └── releases/
│       ├── RELEASE_NOTES_$11.13.0.md     ← Moved here
│       ├── GITHUB_RELEASE_$11.13.0.md    ← Moved here
...
✓ Moved: Release notes: RELEASE_NOTES_$11.13.0.md
✓ Moved: GitHub release: GITHUB_RELEASE_$11.13.0.md
