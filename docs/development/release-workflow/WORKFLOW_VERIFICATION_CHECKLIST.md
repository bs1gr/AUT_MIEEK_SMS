...
- [ ] Resolves tag correctly (should be $11.13.0-test)
- [ ] Build step executes
...
- [ ] Installer name format: SMS_Installer_$11.13.0-test.exe
- [ ] SHA256 visible in release notes/summary

### Test 2.6: Manual Tag Dispatch
```
git tag -a $11.13.0-test -m "test"
git push origin $11.13.0-test
```
...
Inputs: tag = $11.13.0-nonexistent
```
...
2. Tag with $11.13.0 to trigger workflows
