...
The $11.13.0 release was blocked due to multiple issues in the release workflow chain:
...
# Actions:
# ✓ Force-deletes existing local tag $11.13.0
# ✓ Fetches and force-deletes remote tag (if exists)
# ✓ Creates new tag $11.13.0
...
- Tag: $11.13.0
- Version: 1.12.8
- Installer: SMS_Installer_$11.13.0.exe
- Size: 156.2 MB
- SHA256: abc123def...
...
**Solution**:
1. Check that tag format is `v*` (e.g., `$11.13.0`)
2. Verify tag was actually pushed: `git ls-remote --tags origin $11.13.0`
