...
The v1.18.3 release was blocked due to multiple issues in the release workflow chain:
...
# ✓ Force-deletes existing local tag v1.18.3
# ✓ Fetches and force-deletes remote tag (if exists)

# ✓ Creates new tag v1.18.3
...
- Tag: v1.18.3
- Version: 1.12.8
- Installer: SMS_Installer_v1.18.3.exe
- Size: 156.2 MB
- SHA256: abc123def...
...
**Solution**:
1. Check that tag format is `v*` (e.g., `v1.18.3`)
2. Verify tag was actually pushed: `git ls-remote --tags origin v1.18.3`
