...
| **Feature Branch** | ✅ Ready | `feature/v11.14.2-phase1` prepared |
...
**What This Means:**
- We're currently at v1.14.2 (stable)
- Phase 1 work targets v1.15.0 (will bump on Jan 24 release)
...
- [ ] Feature branch `feature/v11.14.2-phase1` created/verified
