...
This document establishes **production baseline metrics** for the Student Management System v1.18.3. These baselines will be used for:
...
The Student Management System v1.18.3 is deployed with:
