...
This document establishes **production baseline metrics** for the Student Management System $11.17.6. These baselines will be used for:
...
The Student Management System $11.17.6 is deployed with:
