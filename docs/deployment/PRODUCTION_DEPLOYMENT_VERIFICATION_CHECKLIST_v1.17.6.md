# Production Deployment Verification Checklist - v1.18.3
...
- **Production Guide**: `docs/deployment/PRODUCTION_GO_LIVE_GUIDE_v1.18.3.md`
...
- **Restore Procedure**: See `docs/deployment/PRODUCTION_GO_LIVE_GUIDE_v1.18.3.md`
