...
### Phase 1: Create Consolidated Documents (30 min)

#### Task 1.1: Create DEVELOPMENT_SETUP_GUIDE.md
**Location**: `docs/development/DEVELOPMENT_SETUP_GUIDE.md`

**Content Sources** (consolidate 4 files):
1. VALIDATION_STATUS.md → Section "Repository Health & Validation"
2. PYTEST_FIX_GUIDE.md → Section "Testing Setup & Troubleshooting"
3. IMMEDIATE_FIX_INSTRUCTIONS.md → Section "Quick Start"
4. QUICK_START_TESTING.md → Section "Requirements Installation"
...
## Prerequisites
[From IMMEDIATE_FIX_INSTRUCTIONS.md]

## Testing Setup
### Backend Testing
[From PYTEST_FIX_GUIDE.md - pytest/Python 3.13]

### Frontend Testing
[From VALIDATION_STATUS.md]

## Pre-commit Validation
[From VALIDATION_STATUS.md]

## Troubleshooting
[From PYTEST_FIX_GUIDE.md]

## Repository Health
[From VALIDATION_STATUS.md]
```

**Estimated Size**: ~300 lines (vs 550 lines across 4 files)
...
**Changes**:
- Rename for clarity (ANALYSIS → GUIDE)
- Update header metadata
- Add reference in docs/operations/SCRIPTS_GUIDE.md

---

### Phase 2: Archive Session Documents (15 min)

#### Task 2.1: Create Session Archive
```powershell
# Create session directory
New-Item -ItemType Directory -Path "archive/sessions/2025-11-28" -Force

# Move session document
Move-Item "REPOSITORY_AUDIT_SUMMARY.md" "archive/sessions/2025-11-28/"
...
**Location**: `archive/sessions/2025-11-28/INDEX.md`

**Content**:
```markdown
# Session 2025-11-28 - Comprehensive Repository Audit

## Summary
Complete documentation audit, cleanup script analysis, and testing setup consolidation.

## Documents Created
1. REPOSITORY_AUDIT_SUMMARY.md - Full workspace audit (425 lines)
2. CLEANUP_SCRIPTS_ANALYSIS.md → docs/operations/CLEANUP_SCRIPTS_GUIDE.md
3. DEVELOPMENT_SETUP_GUIDE.md - Consolidated testing guide (300 lines)
...
## Outcome
- Root directory: 9→5 files (-44%)
- Documentation duplication: -250 lines
- Testing setup: Single comprehensive guide
- Repository status: CLEAN & COMMIT-READY

## Related Sessions
- 2025-11-27: Script consolidation (COMMIT_READY.ps1)
- 2025-11-22: Documentation consolidation
- 2025-11-20: Codebase analysis (8.5/10)
```

---

### Phase 3: Update Documentation References (20 min)
...
### Phase 4: Cleanup & Validation (15 min)
...
# - Deleted: 5 (consolidated files + CLEANUP_SCRIPTS_ANALYSIS.md from root)
# - Renamed: 1 (REPOSITORY_AUDIT_SUMMARY.md → archive/)
```
...
| Archive Documentation | 151 | ~30,425 | +1 session |
...
- [ ] All testing/setup info in single comprehensive guide
- [ ] Cleanup scripts documented in operations/
- [ ] Session documents archived with index
- [ ] No broken links in DOCUMENTATION_INDEX.md

### Repository Health
- [ ] Clean git status (no untracked duplicates)
- [ ] All references updated
- [ ] README.md maintenance section current
- [ ] Archive structure enhanced with sessions/

### User Experience
- [ ] Single source of truth for testing setup
- [ ] Clear navigation from README → guides
- [ ] Cleanup scripts easy to find
- [ ] Session history preserved and indexed
...
- Move & rename CLEANUP_SCRIPTS_ANALYSIS.md

**Phase 2**: Archive session documents (15 min)
- Create archive/sessions/2025-11-28/
- Move REPOSITORY_AUDIT_SUMMARY.md
- Create session INDEX.md

**Phase 3**: Update references (20 min)
...
### Follow-up (This Week)
- [ ] Run `.\COMMIT_READY.ps1 -Mode quick` to verify
- [ ] Review consolidated guides for clarity
...
### Next Steps
1. Execute Phase 1-4 (~80 minutes)
2. Review consolidated documents for clarity
3. Run validation: `.\COMMIT_READY.ps1 -Mode quick`
4. Commit with comprehensive message
5. Update any additional references discovered
