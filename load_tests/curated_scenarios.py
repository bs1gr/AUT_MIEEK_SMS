...
class CuratedUser(HttpUser):
    ...
    def list_students_small(self):
        ...
        self.client.get(
            f"/api/v1/students?skip={skip}&limit=10",
            name="/api/v1/students?limit=10"
        )
    ...
    def list_students_medium(self):
        ...
        self.client.get(
            f"/api/v1/students?skip={skip}&limit=50",
            name="/api/v1/students?limit=50"
        )
    ...
    def list_students_large(self):
        ...
        self.client.get(
            ...
            name="/api/v1/students?limit=100"
        )
    ...
    def list_courses_small(self):
        ...
        self.client.get(
            f"/api/v1/courses?skip={skip}&limit=10",
            name="/api/v1/courses?limit=10"
        )
    ...
    def list_courses_medium(self):
        ...
        self.client.get(
            "/api/v1/courses?skip=0&limit=50",
            name="/api/v1/courses?limit=50"
        )
