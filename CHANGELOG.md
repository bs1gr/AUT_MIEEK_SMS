...
### Bug Fixes
- **ci**: avoid GHCR push failures without package token
- **ci**: resolve frontend tsc and backend mypy pipeline failures
...
### Documentation
- align release prep status with latest CI and metadata
- prepare next major release documentation package
- prepare post-v1.17.9 release documentation
...
### Chores
- **release**: bump version to 1.17.9 and update docs
